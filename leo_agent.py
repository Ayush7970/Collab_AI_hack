...
Craft a chill and welcoming initial proposal in 1-2 sentences to start the negotiation.
"""
...
Reply with a relaxed, easy-going counter-proposal in 1-2 sentences.
"""
    res = groq.chat.completions.create(
        model="llama3-70b-8192",
        messages=[{"role": "user", "content": prompt}]
